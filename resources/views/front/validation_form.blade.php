    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-2xl border border-gray-200 p-6 sm:p-8">
            ...
            <form action="{{ route('validation.process') }}" method="POST">
                @csrf
                <div class="mb-6">
                    <label class="block text-sm font-bold text-gray-700 mb-2">Nomor Invoice / Kode Booking</label>
                    <div class="relative">
                        <input type="text" name="invoice_number" required class="block w-full px-4 py-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent text-lg" placeholder="Contoh: 00123, SH-..., atau APT-..." value="{{ old('invoice_number') }}">
                    </div>
                    <p class="mt-2 text-sm text-gray-500">Masukkan 5 digit nomor invoice Sewa Mobil atau Kode Booking tiket Shuttle/Antar Jemput Anda.</p>
                </div>
