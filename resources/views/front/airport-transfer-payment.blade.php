                ...
                <div class="p-8 lg:p-10">
                    ...
                    <div class="flex flex-col md:flex-row items-center gap-6 pb-8 border-b border-slate-100">
                        ...
                        <div class="flex-1 w-full text-center md:text-left">
                            ...
                            <h2 class="text-2xl font-bold text-slate-900">Antar Jemput: {{ $booking->car->brand }} {{ $booking->car->name }}</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 py-8 border-b border-slate-100">
                        <div>
                            <h3 class="text-sm font-bold text-slate-900 uppercase tracking-widest mb-4">Informasi Penjemputan</h3>
                            <div class="space-y-3">
                                <div>
                                    <p class="text-xs text-slate-500 font-medium">Tipe Layanan</p>
                                    <p class="font-bold text-slate-900">{{ $booking->transfer_type == 'to_airport' ? 'Ke Bandara' : 'Dari Bandara' }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500 font-medium">Waktu Penjemputan</p>
                                    <p class="font-bold text-slate-900">{{ \Carbon\Carbon::parse($booking->pickup_datetime)->format('d F Y, H:i') }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-slate-500 font-medium">Bandara</p>
                    ...
                    <div class="pt-8 border-t border-slate-100" x-data="{
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
                            ...
                            @if(in_array($booking->payment_status, ['unpaid', 'pending']))
                                ...
                                <!-- Manual Form -->
                                <form id="manual-payment-form" x-show="method !== 'midtrans'" style="display: none;" action="{{ route('airport-transfer.manual', $booking->booking_code) }}" method="POST" enctype="multipart/form-data" class="w-full">
                                    @csrf
