<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-3xl font-bold text-slate-900 tracking-tight">Create an account</h2>
        <p class="text-slate-500 mt-2">Join us and start your journey today.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full bg-slate-50/50 border-slate-200 focus:bg-white transition-colors duration-200" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="John Doe" />
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full bg-slate-50/50 border-slate-200 focus:bg-white transition-colors duration-200" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="john@example.com" />
        ...
        <div>
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full bg-slate-50/50 border-slate-200 focus:bg-white transition-colors duration-200"
                            type="password"
