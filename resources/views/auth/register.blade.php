<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <p class="text-slate-400 mt-2">Join us and start your journey today.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Full Name')" class="text-slate-300 font-semibold" />
            <x-text-input id="name" class="block mt-1 w-full bg-slate-900/50 border-slate-700/50 text-white focus:bg-slate-900 focus:border-indigo-500 focus:ring-indigo-500 transition-colors duration-200 placeholder:text-slate-500" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="John Doe" />
